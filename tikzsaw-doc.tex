...
\lstdefinestyle{jigsawstyle}{%
	...
	moretexcs={marmot,path,definecolor,scalebox,foreach,node,draw,clip,PassOptionsToPackage,usetikzlibrary,selectcolormodel,colorlet,includegraphics,tikzset,shade,duck},
...
The \tikzsaw package allows to draw adjustable jigsaw pieces in \TikZ, to combine them and even to automatically create complete jigsaws. It is based on the TeX.Stackexchange answers \url{https://tex.stackexchange.com/a/446296/36296}.
